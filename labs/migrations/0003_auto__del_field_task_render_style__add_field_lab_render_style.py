...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.render_style'
        db.delete_column(u'labs_task', 'render_style')

        # Adding field 'Lab.render_style'
        db.add_column(u'labs_lab', 'render_style',
                      self.gf('django.db.models.fields.CharField')(default='labs/lab.html', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.render_style'
        db.add_column(u'labs_task', 'render_style',
                      self.gf('django.db.models.fields.CharField')(default='labs/lab.html', max_length=50),
                      keep_default=False)

        # Deleting field 'Lab.render_style'
        db.delete_column(u'labs_lab', 'render_style')
