...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskEx.user'
        db.delete_column(u'labs_taskex', 'user')


    def backwards(self, orm):
        # Adding field 'TaskEx.user'
        db.add_column(u'labs_taskex', 'user',
    ...
    models = {
        ...
        u'labs.labex': {
            ...
            'render_style': ('django.db.models.fields.CharField', [], {'default': "'text'", 'max_length': '50'}),
