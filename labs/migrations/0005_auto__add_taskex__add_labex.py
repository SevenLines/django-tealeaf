...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'labs', ['TaskEx'])

        # Adding model 'LabEx'
        db.create_table(u'labs_labex', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('render_style', self.gf('django.db.models.fields.CharField')(default='labs/lab.html', max_length=50)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['filer.Image'], null=True, blank=True)),
        ))
        db.send_create_signal(u'labs', ['LabEx'])


    def backwards(self, orm):
        # Deleting model 'TaskEx'
        db.delete_table(u'labs_taskex')

        # Deleting model 'LabEx'
        db.delete_table(u'labs_labex')
    ...
    models = {
        ...
        u'labs.lab': {
            'Meta': {'ordering': "['order']", 'object_name': 'Lab', '_ormbases': ['cms.CMSPlugin']},
        ...
        u'labs.task': {
            'Meta': {'ordering': "['task_number']", 'object_name': 'Task'},
        ...
        u'labs.taskex': {
            'Meta': {'ordering': "['task_number']", 'object_name': 'TaskEx', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'complexity': ('django.db.models.fields.CharField', [], {'default': "'easy'", 'max_length': '20'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
