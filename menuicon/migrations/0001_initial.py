...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'menuicon_menuicon', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['menuicon.MenuIcon'])),
        ...
        db.send_create_signal(u'menuicon', ['MenuIcon'])


    def backwards(self, orm):
        # Deleting model 'MenuIcon'
        db.delete_table(u'menuicon_menuicon')
    ...
    models = {
        ...
        u'menuicon.menuicon': {
            ...
            'public_extension': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'draft_extension'", 'unique': 'True', 'null': 'True', 'to': u"orm['menuicon.MenuIcon']"})
        },
        u'sites.site': {
