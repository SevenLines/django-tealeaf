...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.captain'
        db.add_column(u'students_group', 'captain',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='group_captain', null=True, on_delete=models.SET_NULL, to=orm['students.Student']),
                      keep_default=False)


        # Changing field 'Group.ancestor'
        db.alter_column(u'students_group', 'ancestor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['students.Group'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'Group.captain'
        db.delete_column(u'students_group', 'captain_id')


        # Changing field 'Group.ancestor'
        db.alter_column(u'students_group', 'ancestor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['students.Group'], null=True))
