...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mark.mark'
        db.delete_column(u'students_mark', 'mark')
        db.add_column(u'students_mark', 'mark', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Mark.mark'
        db.delete_column(u'students_mark', 'mark')
        db.add_column(u'students_mark', 'mark', self.gf('django.db.models.fields.CharField')(max_length=10))
