...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'students_student', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Student.email'
        db.add_column(u'students_student', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)

        # Adding field 'Student.vk'
        db.add_column(u'students_student', 'vk',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'students_student', 'phone')

        # Deleting field 'Student.email'
        db.delete_column(u'students_student', 'email')

        # Deleting field 'Student.vk'
        db.delete_column(u'students_student', 'vk')
