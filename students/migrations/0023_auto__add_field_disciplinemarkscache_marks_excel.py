...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DisciplineMarksCache.marks_excel'
        db.add_column(u'students_disciplinemarkscache', 'marks_excel',
                      self.gf('django.db.models.fields.BinaryField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DisciplineMarksCache.marks_excel'
        db.delete_column(u'students_disciplinemarkscache', 'marks_excel')
    ...
    models = {
        ...
        u'students.disciplinemarkscache': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marks_excel': ('django.db.models.fields.BinaryField', [], {'null': 'True'}),
        ...
        u'students.student': {
            ...
            'photo': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '255'}),
