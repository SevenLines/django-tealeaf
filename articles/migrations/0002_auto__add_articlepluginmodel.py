...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'articles_articlepluginmodel', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('article_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Article'])),
        ))
        db.send_create_signal(u'articles', ['ArticlePluginModel'])


    def backwards(self, orm):
        # Deleting model 'ArticlePluginModel'
        db.delete_table(u'articles_articlepluginmodel')
    ...
    models = {
        ...
        u'articles.articlepluginmodel': {
            ...
            'article_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['articles.Article']"}),
