...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_page_mainpage', 'current_item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main_page.MainPageItem'], null=True, on_delete=models.SET_NULL))
