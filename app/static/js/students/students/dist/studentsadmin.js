 ...
 */
define('app/student',['knockout', 'helpers', 'student-urls'], function (ko, helpers, urls) {
 ...
 * Created by m on 24.02.15.
 */
define('app/group',['knockout'], function (ko) {
    return function (data) {
        var self = this;
        self.id = data.id;
...
define('modal_confirm',["knockout"], function (ko) {
    return function(data) {
        /**
...
(function (factory) {
	if (typeof define === 'function' && define.amd) {
		// AMD
		define('app/../../../../bower_components/jquery.cookie/jquery.cookie.js',['jquery'], factory);
 ...
 * Created by m on 24.02.15.
 */
define('app/student_view_model',["knockout", "app/student", "app/group", 'modal_confirm', 'helpers', '../../../../bower_components/jquery.cookie/jquery.cookie.js'],
    function (ko, Student, Group, ModalConfirm) {
        return function (data, modal_selector) {
            var self = this;
