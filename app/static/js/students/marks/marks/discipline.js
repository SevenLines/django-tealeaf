	...
	return function (data, model) {
		...
		self.save = function (ondone, onfail) {
			if (urls.url.discipline_edit) {
				...
				throw new Error("urls.url.discipline_edit is not defined");
			}
		};

		self.add = function (ondone, onfail) {
			if (urls.url.discipline_add) {
				...
				throw new Error("urls.url.discipline_add is not defined");
			}
		};
