 ...
 * MIT License
 */
define('jquery.toc', ['jquery'], function (jQuery) {
    (function (t) {
        t.fn.toc = function (e) {
...
define('select2binding',['knockout', 'select2'], function (ko, select2) {
...
(function(root, factory) {
	if (typeof define === 'function' && define.amd) {
		define('jquery-impromptu',['jquery'], factory);
	} else {
		factory(root.jQuery);
	}
}(this, function($) {
