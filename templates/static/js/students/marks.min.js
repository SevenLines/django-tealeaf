...
(function(a,b){"function"==typeof define&&define.amd?define(["jquery"],b):b(a.jQuery)})(this,function(a){var b=function(d,c){var e=this;return e.id=b.count++,b.lifo.push(e),d&&e.open(d,c),e};b.defaults={prefix:"jqi",classes:{box:"",fade:"",prompt:"",form:"",close:"",title:"",message:"",buttons:"",button:"",defaultButton:""},title:"",closeText:"&times;",buttons:{Ok:!0},loaded:function(){},submit:function(){},close:function(){},statechanging:function(){},statechanged:function(){},opacity:0.6,zIndex:999,overlayspeed:"slow",promptspeed:"fast",show:"fadeIn",hide:"fadeOut",focus:0,defaultButton:0,useiframe:!1,top:"15%",position:{container:null,x:null,y:null,arrow:null,width:null},persistent:!0,timeout:0,states:{},state:{name:null,title:"",html:"",buttons:{Ok:!0},focus:0,defaultButton:0,position:{container:null,x:null,y:null,arrow:null,width:null},submit:function(){return !0}}},b.setDefaults=function(c){b.defaults=a.extend({},b.defaults,c)},b.setStateDefaults=function(c){b.defaults.state=a.extend({},b.defaults.state,c)},b.count=0,b.lifo=[],b.getLast=function(){var c=b.lifo.length;return c>0?b.lifo[c-1]:!1},b.removeFromStack=function(d){for(var c=b.lifo.length-1;c>=0;c--){if(b.lifo[c].id===d){return b.lifo.splice(c,1)[0]}}},b.prototype={id:null,open:function(k,h){var g=this;g.options=a.extend({},b.defaults,h),g.timeout&&clearTimeout(g.timeout),g.timeout=!1;var w=g.options,t=a(document.body),c=a(window),v='<div class="'+w.prefix+"box "+w.classes.box+'">';v+=w.useiframe&&a("object, applet").length>0?'<iframe src="javascript:false;" style="display:block;position:absolute;z-index:-1;" class="'+w.prefix+"fade "+w.classes.fade+'"></iframe>':'<div class="'+w.prefix+"fade "+w.classes.fade+'"></div>',v+='<div class="'+w.prefix+" "+w.classes.prompt+'"><form action="javascript:false;" onsubmit="return false;" class="'+w.prefix+"form "+w.classes.form+'"><div class="'+w.prefix+"close "+w.classes.close+'">'+w.closeText+'</div><div class="'+w.prefix+'states"></div></form></div></div>',g.jqib=a(v).appendTo(t),g.jqi=g.jqib.children("."+w.prefix),g.jqif=g.jqib.children("."+w.prefix+"fade"),k.constructor===String&&(k={state0:{title:w.title,html:k,buttons:w.buttons,position:w.position,focus:w.focus,defaultButton:w.defaultButton,submit:w.submit}}),g.options.states={};var m,j;for(m in k){j=a.extend({},b.defaults.state,{name:m},k[m]),g.addState(j.name,j),""===g.currentStateName&&(g.currentStateName=j.name)}g.jqi.on("click","."+w.prefix+"buttons button",function(){var z=a(this),s=z.parents("."+w.prefix+"state"),A=g.options.states[s.data("jqi-name")],o=s.children("."+w.prefix+"message"),x=A.buttons[z.text()]||A.buttons[z.html()],p={};if(void 0===x){for(var y in A.buttons){(A.buttons[y].title===z.text()||A.buttons[y].title===z.html())&&(x=A.buttons[y].value)}}a.each(g.jqi.children("form").serializeArray(),function(f,i){void 0===p[i.name]?p[i.name]=i.value:typeof p[i.name]===Array||"object"==typeof p[i.name]?p[i.name].push(i.value):p[i.name]=[p[i.name],i.value]});var d=new a.Event("impromptu:submit");d.stateName=A.name,d.state=s,s.trigger(d,[x,o,p]),d.isDefaultPrevented()||g.close(!0,x,o,p)});var e=function(){if(w.persistent){var f=(""+w.top).indexOf("%")>=0?c.height()*(parseInt(w.top,10)/100):parseInt(w.top,10),d=parseInt(g.jqi.css("top").replace("px",""),10)-f;a("html,body").animate({scrollTop:d},"fast",function(){var i=0;g.jqib.addClass(w.prefix+"warning");var l=setInterval(function(){g.jqib.toggleClass(w.prefix+"warning"),i++>1&&(clearInterval(l),g.jqib.removeClass(w.prefix+"warning"))},100)})}else{g.close(!0)}},q=function(x){var o=window.event?event.keyCode:x.keyCode;if(27===o&&e(),13===o){var y=g.getCurrentState().find("."+w.prefix+"defaultbutton"),d=a(x.target);d.is("textarea,."+w.prefix+"button")===!1&&y.length>0&&(x.preventDefault(),y.click())}if(9===o){var p=a("input,select,textarea,button",g.getCurrentState()),l=!x.shiftKey&&x.target===p[p.length-1],s=x.shiftKey&&x.target===p[0];if(l||s){return setTimeout(function(){if(p){var f=p[s===!0?p.length-1:0];f&&f.focus()}},10),!1}}};return g.position(),g.style(),g._windowResize=function(d){g.position(d)},c.resize({animate:!1},g._windowResize),g.jqif.click(e),g.jqi.find("."+w.prefix+"close").click(function(){g.close()}),g.jqib.on("keydown",q).on("impromptu:loaded",w.loaded).on("impromptu:close",w.close).on("impromptu:statechanging",w.statechanging).on("impromptu:statechanged",w.statechanged),g.jqif[w.show](w.overlayspeed),g.jqi[w.show](w.promptspeed,function(){var d=g.jqi.find("."+w.prefix+"states ."+w.prefix+"state").eq(0);g.goToState(d.data("jqi-name")),g.jqib.trigger("impromptu:loaded")}),w.timeout>0&&(g.timeout=setTimeout(function(){g.close(!0)},w.timeout)),g},close:function(d,g,f,e){var c=this;return b.removeFromStack(c.id),c.timeout&&(clearTimeout(c.timeout),c.timeout=!1),c.jqib&&c.jqib[c.options.hide]("fast",function(){c.jqib.trigger("impromptu:close",[g,f,e]),c.jqib.remove(),a(window).off("resize",c._windowResize),"function"==typeof d&&d()}),c.currentStateName="",c},addState:function(x,q,k){var H,E,e,G,A,w=this,j="",B=null,C="",t="",y=w.options,F=a("."+y.prefix+"states"),z=[],D=0;if(q=a.extend({},b.defaults.state,{name:x},q),null!==q.position.arrow&&(C='<div class="'+y.prefix+"arrow "+y.prefix+"arrow"+q.position.arrow+'"></div>'),q.title&&""!==q.title&&(t='<div class="lead '+y.prefix+"title "+y.classes.title+'">'+q.title+"</div>"),H=q.html,"function"==typeof q.html&&(H="Error: html function must return text"),j+='<div class="'+y.prefix+'state" data-jqi-name="'+x+'" style="display:none;">'+C+t+'<div class="'+y.prefix+"message "+y.classes.message+'">'+H+'</div><div class="'+y.prefix+"buttons "+y.classes.buttons+'"'+(a.isEmptyObject(q.buttons)?'style="display:none;"':"")+">",a.isArray(q.buttons)){z=q.buttons}else{if(a.isPlainObject(q.buttons)){for(e in q.buttons){q.buttons.hasOwnProperty(e)&&z.push({title:e,value:q.buttons[e]})}}}for(D=0,A=z.length;A>D;D++){G=z[D],E=q.focus===D||isNaN(q.focus)&&q.defaultButton===D?y.prefix+"defaultbutton "+y.classes.defaultButton:"",j+='<button class="'+y.classes.button+" "+y.prefix+"button "+E,G.classes!==void 0&&(j+=" "+(a.isArray(G.classes)?G.classes.join(" "):G.classes)+" "),j+='" name="'+y.prefix+"_"+x+"_button"+G.title.replace(/[^a-z0-9]+/gi,"")+'" value="'+G.value+'">'+G.title+"</button>"}return j+="</div></div>",B=a(j),B.on("impromptu:submit",q.submit),void 0!==k?F.find('[data-jqi-name="'+k+'"]').after(B):F.append(B),w.options.states[x]=q,B},removeState:function(d,f){var c=this,h=c.getState(d),g=function(){h.remove()};return 0===h.length?!1:("none"!==h.css("display")?void 0!==f&&c.getState(f).length>0?c.goToState(f,!1,g):h.next().length>0?c.nextState(g):h.prev().length>0?c.prevState(g):c.close():h.slideUp("slow",g),!0)},getApi:function(){return this},getBox:function(){return this.jqib},getPrompt:function(){return this.jqi},getState:function(c){return this.jqi.find('[data-jqi-name="'+c+'"]')},getCurrentState:function(){return this.getState(this.getCurrentStateName())},getCurrentStateName:function(){return this.currentStateName},position:function(t){var m=this,j=a.fx.off,h=m.getCurrentState(),y=m.options.states[h.data("jqi-name")],w=y?y.position:void 0,c=a(window),x=document.body.scrollHeight,q=a(window).height(),k=(a(document).height(),x>q?x:q),g=parseInt(c.scrollTop(),10)+((""+m.options.top).indexOf("%")>=0?q*(parseInt(m.options.top,10)/100):parseInt(m.options.top,10));if(void 0!==t&&t.data.animate===!1&&(a.fx.off=!0),m.jqib.css({position:"absolute",height:k,width:"100%",top:0,left:0,right:0,bottom:0}),m.jqif.css({position:"fixed",height:k,width:"100%",top:0,left:0,right:0,bottom:0}),w&&w.container){var v=a(w.container).offset();a.isPlainObject(v)&&void 0!==v.top&&(m.jqi.css({position:"absolute"}),m.jqi.animate({top:v.top+w.y,left:v.left+w.x,marginLeft:0,width:void 0!==w.width?w.width:null}),g=v.top+w.y-((""+m.options.top).indexOf("%")>=0?q*(parseInt(m.options.top,10)/100):parseInt(m.options.top,10)),a("html,body").animate({scrollTop:g},"slow","swing",function(){}))}else{w&&w.width?(m.jqi.css({position:"absolute",left:"50%"}),m.jqi.animate({top:w.y||g,left:w.x||"50%",marginLeft:-1*(w.width/2),width:w.width})):m.jqi.css({position:"absolute",top:g,left:"50%",marginLeft:-1*(m.jqi.outerWidth(!1)/2)})}void 0!==t&&t.data.animate===!1&&(a.fx.off=j)},style:function(){var c=this;c.jqif.css({zIndex:c.options.zIndex,display:"none",opacity:c.options.opacity}),c.jqi.css({zIndex:c.options.zIndex+1,display:"none"}),c.jqib.css({zIndex:c.options.zIndex})},goToState:function(m,j,g){var d=this,t=(d.jqi,d.options),p=d.getState(m),c=t.states[p.data("jqi-name")],q=new a.Event("impromptu:statechanging"),k=d.options;if(void 0!==c){if("function"==typeof c.html){var h=c.html;p.find("."+k.prefix+"message ").html(h())}"function"==typeof j&&(g=j,j=!1),d.jqib.trigger(q,[d.getCurrentStateName(),m]),!q.isDefaultPrevented()&&p.length>0&&(d.jqi.find("."+k.prefix+"parentstate").removeClass(k.prefix+"parentstate"),j?(d.jqi.find("."+k.prefix+"substate").not(p).slideUp(t.promptspeed).removeClass("."+k.prefix+"substate").find("."+k.prefix+"arrow").hide(),d.jqi.find("."+k.prefix+"state:visible").addClass(k.prefix+"parentstate"),p.addClass(k.prefix+"substate")):d.jqi.find("."+k.prefix+"state").not(p).slideUp(t.promptspeed).find("."+k.prefix+"arrow").hide(),d.currentStateName=c.name,p.slideDown(t.promptspeed,function(){var e=a(this);"string"==typeof c.focus?e.find(c.focus).eq(0).focus():e.find("."+k.prefix+"defaultbutton").focus(),e.find("."+k.prefix+"arrow").show(t.promptspeed),"function"==typeof g&&d.jqib.on("impromptu:statechanged",g),d.jqib.trigger("impromptu:statechanged",[m]),"function"==typeof g&&d.jqib.off("impromptu:statechanged",g)}),j||d.position())}return p},nextState:function(d){var f=this,c=f.getCurrentState().next();return c.length>0&&f.goToState(c.data("jqi-name"),d),c},prevState:function(d){var f=this,c=f.getCurrentState().prev();return c.length>0&&f.goToState(c.data("jqi-name"),d),c}},a.prompt=function(d,c){var e=new b(d,c);return e.jqi},a.each(b,function(d,c){a.prompt[d]=c}),a.each(b.prototype,function(c){a.prompt[c]=function(){var d=b.getLast();return d&&"function"==typeof d[c]?d[c].apply(d,arguments):void 0}}),a.fn.prompt=function(c){void 0===c&&(c={}),void 0===c.withDataAndEvents&&(c.withDataAndEvents=!1),a.prompt(a(this).clone(c.withDataAndEvents).html(),c)},window.Impromptu=b});function ModalConfirm(b){b=b?b:{};if(b.prototype){return}var a=this;a.modal_selector=b.modal_selector;a.message=ko.observable(b.message);a.header=ko.observable(b.header);a.variable_name=b.variable_name;a.label={yes:"Да",no:"Нет"};a.custom_modal_body=b.custom_modal_body?b.custom_modal_body:"";a.callback_confirm=null;a.callback_decline=null;a._generate_modal=function(){if(a.variable_name==null){console.error("One should pass variable_name to use autogenerate modal:\nvar modalForm = new ModalConfirm({variable_name: 'modalForm'})");return}var d="modal-"+a.variable_name;$("#"+d).remove();var c='<div id="'+d+'" class="modal fade" role="dialog" data-bind="with: '+a.variable_name+'"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" data-bind="text: header"></div><div class="modal-body"><span data-bind="html: message"></span>'+a.custom_modal_body+'</div><div class="modal-footer"><button type="button" class="btn btn-default" data-decline data-dismiss="modal">'+a.label.no+'</button><button type="button" class="btn btn-danger" data-confirm data-dismiss="modal">'+a.label.yes+"</button></div></div></div></div>";$("body").prepend(c);return"#"+d};a.init=function(){if(a.modal_selector==null){a.modal_selector=a._generate_modal()}$(a.modal_selector).find("[data-confirm]").unbind("click");$(a.modal_selector).find("[data-confirm]").click(function(){if(a.callback_confirm){a.callback_confirm()}});$(a.modal_selector).find("[data-decline]").unbind("click");$(a.modal_selector).find("[data-decline]").click(function(){if(a.callback_decline){a.callback_decline()}})};a.show=function(c,d){a.callback_confirm=c===undefined?null:c;a.callback_decline=d===undefined?null:d;$(a.modal_selector).modal("show")};a.init()}ko.bindingHandlers.img={init:function(b,c,d){var a=d().image_loaded;if(a){a(false)}b.src=c()()==null?"":c()();$(b).unbind();$(b).on("load",function(){if(a){a(true)}if(c()()!=b.src){c()(b.src)}})},update:function(b,c,d){var a=d().image_loaded;if(a){a(false)}if(b.src!=c()()){b.src=c()()==null?"":c()()}}};ko.bindingHandlers.input={init:function(a,b,c){a.value=b()()==null?"":b()();$(a).on("change",function(){b()(a.value)})}};function Discipline(c,b){var a=this;a.model=b;a.url={edit:c.url?c.url.edit:"",remove:c.url?c.url.remove:""};a.id=c.id;a.year=ko.observable(c.year);a.title=ko.observable(c.title);a.visible=ko.observable(c.visible);a.toggleDiscipline=function(){$.post(b.url.discipline_edit,b.csrfize({id:a.id,visible:!a.visible()})).done(function(){a.visible(a.visible());InterfaceAlerts.showSuccess()}).fail(function(){InterfaceAlerts.showFail()})}}(function(){var b=[];var f=Color("#FDD").lighten(0.03);var d=Color("#89EB04").lighten(0.5);function a(g,i){var h=this;h.mark_selector=$(g);h.type=ko.observable();h.mark=null;var k={left:0,top:0};var j=false;h.show=function(n,r){h.mark=n;var o=$(r).offset();var l=r.clientWidth*1.1;var v=r.clientHeight;var q=$.map(h.mark_types(),function(w){return w.k}).indexOf(n.mark());var t=28;var u=h.mark_selector.find("ul").first().width();var s=h.mark_selector.show().offset({left:o.left-u/2+l/2,top:o.top-u/2+v/2}).find("li");k.left=o.left+(l-t)/2;k.top=o.top+(v-t)/2;if(s.size()){var p=35;var m=2*Math.PI/(s.size());s.each(function(w,x){if(w!=q){$(x).offset({left:k.left+p*Math.cos(w*m),top:k.top+p*Math.sin(w*m)})}else{$(x).offset({left:k.left,top:k.top})}})}if(h.mark&&h.mark.student){h.mark.student.toggleActive(true)}j=true;h.mark_selector.find(".mark").removeClass("lect exam test current");h.mark_selector.find(".mark").toggleClass(n.lesson.style(),true);h.mark_selector.find(".mark."+b[n.mark()]).toggleClass("current",true)};h.close=function(){j=false;h.mark_selector.hide();if(h.mark&&h.mark.student){h.mark.student.toggleActive(false)}h.mark_selector.find("li").removeAttr("style")};h.init=function(){$("body").click(function(){if(j){h.close()}});$(document).keypress(function(l){if(l.keyCode==27){h.close()}})};h.mark_types=i;h.setMark=function(l){h.mark.mark(l.k);h.close()};h.init()}c.prototype=new ModalConfirm({prototype:true});c.prototype.constructor=ModalConfirm;function c(){var g=this;g.title=ko.observable("");arguments[0].custom_modal_body=['<form class="form" data-bind="submit: function() {}">','<input class="form-control" data-bind="value: title" />',"</form>"].join("\n");ModalConfirm.apply(this,arguments)}Date.prototype.ddmmyyyy=function(){var i=this.getFullYear().toString();var h=(this.getMonth()+1).toString();var g=this.getDate().toString();return(g[1]?g:"0"+g[0])+"/"+(h[1]?h:"0"+h[0])+"/"+i};function e(h){var g=this;g.init=function(){g.loadYears();g.loadDisciplines()};g.url={years:h.url.years,groups:h.url.groups,students:h.url.students,students_control:h.url.students_control,disciplines:h.url.disciplines,discipline_add:h.url.discipline_add,discipline_edit:h.url.discipline_edit,discipline_remove:h.url.discipline_remove,lesson_add:h.url.lesson_add,lesson_remove:h.url.lesson_remove,lesson_save:h.url.lesson_save,marks_save:h.url.marks_save,to_excel:h.url.to_excel,reset_cache:h.url.reset_cache};g.cookie={year:"year",group_id:"group_id",sorting:"students-sorting",score_method:"score-method",expires:7};g.marksTypes=ko.observableArray();g.hideBadStudents=ko.observable(true);g.csrf=h.csrf;g.csrfize=function(i){i.csrfmiddlewaretoken=g.csrf;return i};g._block=false;g.block=function(){g._block=true};g.unblock=function(){g._block=false};g.check_block=function(i){if(!g._block){return i()}return null};g.years=ko.observableArray();g.year=ko.observable();g.groups=ko.observableArray();g.group=ko.observable();g.students=ko.observableArray();g.students_control=ko.observableArray();g.student=ko.observable();g.disciplines=ko.observableArray();g.discipline=ko.observable();g.lessons=ko.observableArray();g.lesson_types=ko.observableArray();g.lesson=ko.observable(new Lesson({}));g.modalDeleteDescipline=new ModalConfirm({variable_name:"modalDeleteDescipline",header:"Потдвердите",message:"Удалить дисциплину?"});g.modalAddDescipline=new c({variable_name:"modalAddDescipline",header:"Дисциплина"});g.modelRemoveLesson=new ModalConfirm({variable_name:"modelRemoveLesson",header:"Потдвердите",message:"Удалить урок?"});g.modelEditLesson=new ModalConfirm({modal_selector:"#modal-lesson-editor",header:"Урок"});g.markSelector=new a("#mark-selector",g.marksTypes);g.year.subscribe(function(){g.check_block(function(){if(g.year()){g.loadGroups()}})});g.group.subscribe(function(){g.check_block(function(){if(g.group()){g.loadStudents()}else{g.students([])}})});g.discipline.subscribe(function(){g.check_block(function(){if(g.group()){g.loadStudents()}else{g.students(null)}})});g.loadYears=function(){g.block();$.get(g.url.years,{},g.years).success(function(j){g.unblock();var i=$.cookie(g.cookie.year);var k=g.years().some(function(l){return l.year==i});if(k){g.year(i)}else{if(g.years().length>0){g.year(g.years()[0].year)}}})};g.loadGroups=function(){g.block();$.get(g.url.groups,{year:g.year()},g.groups).done(function(j){$.cookie(g.cookie.year,g.year(),{expires:g.cookie.expires});var i=$.cookie(g.cookie.group_id);g.groups.sort(function(l,k){return l.title==k.title?0:l.title<k.title?-1:1});g.unblock();if(g.groups().every(function(k){if(i==k.id){g.group(k);return false}return true})){if(g.groups().length){g.group(g.groups()[0])}else{g.group(null)}}})};g.resetMarksInterface=function(){$('thead [data-toggle="tooltip"]').tooltip({placement:"bottom"});$('tfoot [data-toggle="tooltip"]').tooltip({placement:"top"});$(".modal-lesson-editor .dropdown-menu").bind("click",function(m){m.stopPropagation()});$(".lesson-edit").qtip({content:{text:"",title:function(){return"Занятие"}},position:{my:"top center"},show:{solo:true,event:"click",effect:function(){$(this).fadeIn(120)}},hide:{fixed:true,event:null,effect:function(){$(this).fadeOut(120)}},style:{classes:"qtip-bootstrap"},events:{show:function(q,o){var n=$("#template-lesson-edit");o.set("content.text",n);var p=this;$(p).on("click",function(r){r.stopPropagation()});$(p).find(".lesson-date").pickmeup_twitter_bootstrap({hide_on_select:true,format:"d/m/Y",hide:function(r){$(this).trigger("change")}});var m=function(){$(p).unbind("click");$(p).qtip("hide")};$(p).find(".delete, .save").on("click",m);$(document).one("click",m)}}});$("table.table-marks>tbody>tr").hover(function(){var m=$(this).index();$("table.table-marks>tbody").each(function(n,o){$($(o).find(">tr")[m]).addClass("hover")})},function(){var m=$(this).index();$("table.table-marks>tbody").each(function(n,o){$($(o).find(">tr")[m]).removeClass("hover")})});var k=-1;var j=false;var i=$(".marks-list");var l=function(n){var m=n.clientX;if(j){if(k!=-1&&Math.abs(k-m)>2){this.scrollLeft+=k-m;$.cookie("lastScroll",this.scrollLeft)}}k=m};i.mousedown(function(m){if(m.which===1){j=true}});$(document).mouseup(function(m){j=false});i.on("touchmove, mousemove",l);if(i.size()&&$.cookie("lastScroll")){i[0].scrollLeft=$.cookie("lastScroll")}};g.isStudentsLoading=ko.observable(true);g.showLoading=ko.computed(function(){return g.group()&&(g.isStudentsLoading()||(g.students&&g.students().length==0))});g.loadStudents=function(){g.isStudentsLoading(true);setTimeout(function(){$.get(g.url.students,{group_id:g.group().id,discipline_id:g.discipline()?g.discipline().id:-1}).done(function(l){g.lesson_types(l.lesson_types);b={};g.marksTypes(l.mark_types);l.mark_types.every(function(i){b[i.k]=i.v;if(!b.max<parseInt(i.k)){b.max=parseInt(i.k)}if(!b.min>parseInt(i.k)){b.min=parseInt(i.k)}return true});var j=$.map(l.lessons,function(i){return new Lesson(i)});g.lessons(j);var k=-1;function m(){if(k==-1){g.students.removeAll();setTimeout(m,0);++k}if(k<l.students.length){var i=l.students[k];++k;i.lessons=g.lessons;g.students.push(new Student(i));setTimeout(m,0)}else{g.sortMethod(g.sortMethods[$.cookie(g.cookie.sorting)]);$.cookie(g.cookie.group_id,g.group().id,{expires:g.cookie.expires});g.isStudentsLoading(false);g.resetMarksInterface()}}if(l.students.length>0){m()}}).always(function(){}).fail(function(){g.isStudentsLoading(false);g.resetMarksInterface()})},60)};g.loadStudentsControl=function(){window.location=g.url.students_control+"?"+$.param([{name:"year",value:g.year()},{name:"discipline_id",value:g.discipline().id},{name:"k",value:0.5}])};g.loadDisciplines=function(){$.get(g.url.disciplines).done(function(k){for(var j=0;j<k.length;++j){g.disciplines.push(new Discipline(k[j],g))}}).fail(function(){InterfaceAlerts.showFail()})};g.sortByStudentsMark=function(j,i){return j.sum()==i.sum()?0:j.sum()<i.sum()?1:-1};g.sortByStudentsMark.title="По цвету";g.sortByStudentsName=function(l,k){var j=l.sum()>=0?1:-1;var i=k.sum()>=0?1:-1;if(l.second_name<k.second_name){return j==i?-1:j<i?1:-1}else{if(l.second_name>k.second_name){return j==i?1:j<i?1:-1}else{return 0}}};g.sortByStudentsName.title="По имени";g.sortMethods={};g.sortMethods[g.sortByStudentsMark.title]=g.sortByStudentsMark;g.sortMethods[g.sortByStudentsName.title]=g.sortByStudentsName;g.sortMethods["undefined"]=g.sortByStudentsName;g.sortMethod=ko.observable();g.sortMethod.subscribe(function(){if(g.sortMethod()){g.students.sort(g.sortMethod())}});g.toggleStudentsSorting=function(){g.sortMethod(g.sortMethod()==g.sortByStudentsMark?g.sortByStudentsName:g.sortByStudentsMark);$.cookie(g.cookie.sorting,g.sortMethod().title,{expires:g.cookie.expires})};g.showPercents=ko.observable($.cookie(g.cookie.score_method)!=="false");g.scoreMethod=ko.computed(function(){return g.showPercents()?"в процентах":"в баллах"},g.showPercents);g.toggleScorePercents=function(){g.showPercents(!g.showPercents());$.cookie(g.cookie.score_method,g.showPercents(),{expires:g.cookie.expires})};g.toggleBadStudentHiding=function(){g.hideBadStudents(!g.hideBadStudents())};g.addDiscipline=function(){g.modalAddDescipline.header("Создание новой дисциплины");g.modalAddDescipline.title("");g.modalAddDescipline.show(function(){$.post(g.url.discipline_add,g.csrfize({title:g.modalAddDescipline.title()})).done(function(){g.loadDisciplines()}).fail(function(){InterfaceAlerts.showFail()})})};g.editDiscipline=function(){if(!g.discipline().id){return}g.modalAddDescipline.header('Редактирование дисциплины "'+g.discipline().title+'"');g.modalAddDescipline.title(g.discipline().title);g.modalAddDescipline.show(function(){$.post(g.url.discipline_edit,g.csrfize({id:g.discipline().id,title:g.modalAddDescipline.title()})).done(function(){g.loadDisciplines();InterfaceAlerts.showSuccess()}).fail(function(){InterfaceAlerts.showFail()})})};g.toggleDiscipline=function(){if(g.discipline()){g.discipline().toggleDiscipline()}};g.removeDiscipline=function(i){g.modalDeleteDescipline.message("Удалить дисциплину<h2>"+g.discipline().title+"?</h2>");g.modalDeleteDescipline.show(function(){$.post(g.url.discipline_remove,g.csrfize({id:g.discipline().id})).done(function(){g.disciplines.remove(g.discipline())}).fail(function(){InterfaceAlerts.showFail()})})};g.lessonHover=function(i){g.lesson(i)};g.addLesson=function(){$.post(g.url.lesson_add,g.csrfize({discipline_id:g.discipline().id,group_id:g.group().id})).done(function(){g.loadStudents()}).fail(function(){InterfaceAlerts.showFail()})};g.removeLesson=function(i){g.modelRemoveLesson.show(function(){$.post(g.url.lesson_remove,g.csrfize({lesson_id:i.id})).done(function(){g.loadStudents()}).fail(function(){InterfaceAlerts.showFail()})})};g.saveLesson=function(i){$.post(g.url.lesson_save,g.csrfize({lesson_id:i.id,lesson_type:i.lesson_type(),date:i.isodate(),multiplier:i.multiplier(),description_raw:i.description_raw(),score_ignore:i.score_ignore(),icon_id:i.icon_id()==null?-1:i.icon_id()})).done(function(j){if(i.isodate()!=i.isodate_old){g.loadStudents()}else{i.description(j.description);i.description_raw(j.description_raw)}InterfaceAlerts.showSuccess()}).fail(function(){InterfaceAlerts.showFail()})};g.saveMarks=function(){var k=[];for(var j=0;j<g.students().length;++j){var l=g.students()[j].modified_marks();l.every(function(i){k.push({lesson_id:i.lesson_id,student_id:i.student_id,mark:i.mark()});return true})}$.post(g.url.marks_save,g.csrfize({marks:JSON.stringify(k)})).done(function(){for(var m=0;m<g.students().length;++m){g.students()[m].reset()}InterfaceAlerts.showSuccess()}).fail(function(){InterfaceAlerts.showFail()})};g.toExcel=function(i,j){window.location=g.url.to_excel+"?"+$.param([{name:"group_id",value:g.group().id},{name:"discipline_id",value:g.discipline().id}])};g.resetCache=function(i,j){$.get(g.url.reset_cache).done(function(){window.location.reload()})};g.clickMark=function(i,j){if($.clickMouseMoved()){return false}setTimeout(function(){g.markSelector.show(i,j.target)},10);return false};g.increase=function(i){i.increase()};g.decrease=function(i){i.decrease()};g.init()}window.MarksViewModel=e}());