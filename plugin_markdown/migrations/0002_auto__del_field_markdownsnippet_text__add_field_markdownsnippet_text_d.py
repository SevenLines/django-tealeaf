...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MarkdownSnippet.text'
        db.delete_column(u'plugin_markdown_markdownsnippet', 'text')
    ...
    def backwards(self, orm):
        # Adding field 'MarkdownSnippet.text'
        db.add_column(u'plugin_markdown_markdownsnippet', 'text',
    ...
    models = {
        ...
        u'plugin_markdown.markdownsnippet': {
            ...
            'text_data': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': "'True'"})
        }
    }
