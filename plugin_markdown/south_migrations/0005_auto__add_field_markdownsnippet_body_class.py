...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarkdownSnippet.body_class'
        db.add_column(u'plugin_markdown_markdownsnippet', 'body_class',
                      self.gf('django.db.models.fields.CharField')(default='alert alert-info', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarkdownSnippet.body_class'
        db.delete_column(u'plugin_markdown_markdownsnippet', 'body_class')
    ...
    models = {
        ...
        u'plugin_markdown.markdownsnippet': {
            ...
            'body_class': ('django.db.models.fields.CharField', [], {'default': "'alert alert-info'", 'max_length': '255', 'blank': 'True'}),
