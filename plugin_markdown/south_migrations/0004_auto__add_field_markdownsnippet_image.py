...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarkdownSnippet.image'
        db.add_column(u'plugin_markdown_markdownsnippet', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['filer.Image'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarkdownSnippet.image'
        db.delete_column(u'plugin_markdown_markdownsnippet', 'image_id')
